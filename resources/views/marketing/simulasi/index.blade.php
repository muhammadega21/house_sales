    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">Gunakan kalkulator untuk membandingkan estimasi cicilan unit rumah Anda.</p>
            </div>
        ...
        <x-simulasi-form :units="$units" :konsumen-list="$konsumenOptions" :default-bunga="(float) ($settings['default_kpr_bunga'] ?? 8)" :default-diskon="(float) ($settings['default_cash_keras_diskon'] ?? 0)" :dp-limits="$dpLimits" />
    </div>
@endsection
