            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <x-card title="Checklist Dokumen">
                    ...
                    <div class="mt-4 text-sm text-gray-500">
                        ...
                        <a href="{{ route('marketing.dokumen.index', ['id_konsumen' => $pengajuan->id_konsumen]) }}"
                        ...
                        <div class="space-y-3">
                            @foreach ($otherPengajuans as $other)
                                <div class="rounded-2xl border border-gray-200 bg-gray-50 p-4 text-sm">
                                    ...
                                    <a href="{{ route('marketing.pengajuan-kpr.show', $other->id) }}"
