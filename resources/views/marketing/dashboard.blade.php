                            ...
                            @forelse($prospekTerbaru as $prospek)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-3 py-2 font-medium text-gray-800">
                                        <a href="{{ route('marketing.prospek.show', $prospek->id) }}"
                                            class="hover:text-blue-600">{{ $prospek->nama_prospek }}</a>
                                    </td>
                                    <td class="px-3 py-2 text-gray-600">{{ $prospek->sumber_prospek->label() }}</td>
                                    <td class="px-3 py-2">
                                        <x-badge :status="$prospek->status_prospek" />
                                    </td>
                                    <td class="px-3 py-2 text-gray-500">{{ $prospek->tanggal_prospek->format('d M Y') }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-3 py-2 font-medium text-gray-800">
                                        <a href="{{ route('marketing.konsumen.show', $konsumen->id) }}"
                                            class="hover:text-blue-600">{{ $konsumen->nama_lengkap }}</a>
                                    </td>
