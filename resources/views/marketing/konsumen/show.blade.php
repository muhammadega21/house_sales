                            ...
                            <tbody class="divide-y divide-gray-100 bg-white">
                                @foreach($konsumen->bookings as $booking)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3">
    @php
        $payStatus = $booking->status_pembayaran_fee;
        $payColors = match($payStatus) {
                            ...
                            <tbody class="divide-y divide-gray-100 bg-white">
                                @foreach($konsumen->pengajuanKpr as $pengajuan)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3">Rp {{ number_format($pengajuan->plafon_kpr ?? 0, 0, ',', '.') }}</td>
                                        <td class="px-4 py-3">{{ $pengajuan->tenor_tahun ?? '-' }} tahun</td>
                                        <td class="px-4 py-3">{{ __($pengajuan->status_pengajuan) }}</td>
                                        <td class="px-4 py-3">{{ $pengajuan->tanggal_pengajuan?->format('d/m/Y') }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
