...
<head>
    ...
    <title>Login - {{ config('app.name', 'House Sales System') }}</title>
...
<body class="bg-gray-100 font-sans text-gray-800 antialiased min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gray-900 p-8 text-center text-white">
            <div class="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-600 font-bold text-white text-2xl shadow-lg mb-3">
                HS
            </div>
            <h1 class="text-2xl font-bold tracking-tight">House Sales System</h1>
        ...
        <div class="bg-gray-50 p-4 border-t border-gray-100 text-center">
            <p class="text-xs text-gray-500">&copy; {{ date('Y') }} PT House Sales Indonesia. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
