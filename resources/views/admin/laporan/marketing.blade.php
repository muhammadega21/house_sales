...
@section('content')
    <div class="space-y-6">
        ...
        <x-data-table-toolbar
            :search-route="route('admin.laporan.marketing')"
            ...
            :has-filters="true"
            :exclude-keys="['periode_mulai', 'periode_selesai', 'id_marketing']"
        >
            <x-slot:filters>
        ...
        <!-- Chart: Closing per Marketing -->
        <x-card title="Perbandingan Closing per Marketing">
            <div class="h-80">
                <canvas id="closingPerMarketingChart"></canvas>
            </div>
        </x-card>

        <!-- Tabel Kinerja Marketing -->
        <x-card>
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const barCtx = document.getElementById('closingPerMarketingChart');
                if (barCtx) {
                    new Chart(barCtx, {
                        type: 'bar',
                        data: {
