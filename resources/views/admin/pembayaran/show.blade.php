            ...
            <x-card title="Info Verifikasi">
                <div class="grid gap-4 text-sm md:grid-cols-2">
                    <div>
                        ...
                        <p class="font-semibold text-gray-900">{{ $pembayaran->diverifikasiOleh?->nama_lengkap ?? '-' }}
                        </p>
                    </div>
                    <div>
        ...
        @if ($pembayaran->bukti_bayar)
            ...
            <x-card title="Bukti Pembayaran">
                <div class="flex items-center gap-6 flex-wrap">
                    @if ($isPdf)
                        <div
                            class="flex h-40 w-40 shrink-0 items-center justify-center rounded-xl border-2 border-dashed border-gray-300 bg-gray-100">
                    ...
                    @elseif ($pembayaran->status_verifikasi === \App\Enums\StatusVerifikasi::Ditolak)
                        <li class="relative flex items-start gap-4">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                @if ($pembayaran->catatan_verifikasi)
                                    <p class="text-xs text-gray-400 mt-1">Catatan: {{ $pembayaran->catatan_verifikasi }}
                                    </p>
                                @endif
                                @if ($pembayaran->tanggal_verifikasi)
                                    <p class="text-xs text-gray-400">
