                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        @forelse($pembayarans as $pembayaran)
                            <tr
                                class="{{ $pembayaran->status_verifikasi === \App\Enums\StatusVerifikasi::Pending ? 'bg-yellow-50' : '' }} transition hover:bg-gray-50">
                                <td class="px-4 py-4">
                                    <input type="checkbox" name="ids[]" value="{{ $pembayaran->id }}"
                                        class="checkbox-pembayaran rounded border-gray-300 text-primary">
                                </td>
                                ...
                                <td class="px-4 py-4 text-gray-700">
                                    {{ $pembayaran->booking?->marketing?->nama_lengkap ?? '-' }}</td>
                                <td class="px-4 py-4">
